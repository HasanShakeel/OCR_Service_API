...
def export_pdf(file_contents, coordinates, image_width, image_height, y_offset=10):  
    ...
    c.drawImage(ImageReader(input_image), 0, 0, width=img_width_pdf, height=img_height_pdf)
    ...
    for data in coordinates:
        ...
        if x_coord < 0 or x_coord >= image_width or y_coord < 0 or y_coord >= image_height:
            continue
